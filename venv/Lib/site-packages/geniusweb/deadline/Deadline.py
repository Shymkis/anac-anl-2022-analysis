...
@JsonSubTypes( ["geniusweb.deadline.DeadlineRounds.DeadlineRounds","geniusweb.deadline.DeadlineTime.DeadlineTime","geniusweb.deadline.DeadlineGauss.DeadlineGauss" ])
class Deadline(ABC):
	'''
